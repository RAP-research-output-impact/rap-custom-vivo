...
public class CoPubsByCategory extends CoPubsHttpServlet {
    
    private static final long serialVersionUID = 1L;
    private String TEMPLATE = "copubs-by-category.ftl";
    private static final String PUB_MODEL_QUERY = "coPubByCategory/getModel.rq";
    private static final String PUB_QUERY = "coPubByCategory/getPubs.rq";
    ...
    ResponseValues processRequest(VitroRequest vreq, StoreUtils storeUtils,
        ...
        String categoryUri = namespace + localName;
