...
<#-- RAP modification: uppercase the string to match WoS-style date display -->
<#function formatXsdDateTimeLong dateTime precision>
    <#return formatXsdDateTime(dateTime, precision, "long")?upper_case>
</#function>
...
<#-- RAP modification: the 'long' formats are modified to match the WoS-style publication date display -->
...
<#function getFormat formatType precision>
    ...
    <#local format>
        <#if formatType == "long">
            ...
            <#elseif precision?ends_with("yearMonthPrecision")>MMM yyyy
            <#elseif precision?ends_with("monthPrecision")>MMM
            <#elseif precision?ends_with("yearMonthDayPrecision")>MMM d yyyy
